...
function useNumberInput(props) {
  ...
  var _props = props,
      ...
      htmlProps = _objectWithoutPropertiesLoose(_props, ["focusInputOnChange", "clampValueOnBlur", "keepWithinRange", "min", "max", "step", "isReadOnly", "isDisabled", "getAriaValueText", "isInvalid", "pattern", "inputMode", "allowMouseWheel", "id", "onChange", "precision"]);
  /**
  ...
  (0, _hooks.useEventListener)("wheel", function onWheel(event) {
  ...
  var getIncrementButtonProps = (0, _react.useCallback)(function (props, ref) {
    var _extends2;
  ...
  var getDecrementButtonProps = (0, _react.useCallback)(function (props, ref) {
    var _extends3;
