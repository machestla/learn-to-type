...
var _useFormLabel = require("./use-form-label");

Object.keys(_useFormLabel).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _useFormLabel[key]) return;
  exports[key] = _useFormLabel[key];
});
