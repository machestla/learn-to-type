...
import { ChakraProps, ThemingProps, HTMLChakraProps } from "@chakra-ui/system";
...
export interface ModalOverlayProps extends Omit<HTMLMotionProps<"div">, "color">, Omit<ChakraProps, "transition"> {
    children?: React.ReactNode;
}
/**
