...
function useRadio(props) {
  ...
  var _props = props,
      ...
      value = _props.value,
      id = _props.id,
      htmlProps = _objectWithoutPropertiesLoose(_props, ["defaultIsChecked", "isChecked", "isFocusable", "isDisabled", "isReadOnly", "isRequired", "onChange", "isInvalid", "name", "value", "id"]);
  ...
  var _useState = (0, _react.useState)(Boolean(defaultIsChecked)),
