...
import { useBoolean, useFocusOnShow, useDisclosure, useFocusOnHide, useIds, useOutsideClick } from "@chakra-ui/hooks";
...
export function usePopover(props) {
  ...
  var getPopoverProps = useCallback(function (props, _ref) {
    ...
    return popoverProps;
  }, [isLazy, isOpen, popoverId, hasHeader, headerId, hasBody, bodyId, trigger, popper, closeOnEsc, onClose, closeDelay]);
