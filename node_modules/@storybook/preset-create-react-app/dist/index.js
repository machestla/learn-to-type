...
exports.babelDefault = function () { return ({
    presets: [],
    plugins: [],
}); };
// Ensure that loaders are resolved from react-scripts.
exports.managerWebpack = function (webpackConfig) {
...
exports.webpack = function (webpackConfig, options) {
    ...
    if (typeof scriptsPackageName === 'string') {
        try {
            scriptsPath = IS_USING_YARN_PNP
                ? getReactScriptsPath_1.getReactScriptsPathWithYarnPnp(scriptsPackageName)
                : path_1.dirname(require.resolve(scriptsPackageName + "/package.json"));
        }
        catch (e) {
    ...
    var tsDocgenPlugin = typescriptOptions.reactDocgen === 'react-docgen-typescript'
        ? [
